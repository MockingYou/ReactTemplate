...
const ChartStart = () => {
    ...
    return (
        <>
            <table style={{width: '97%' , height: '50% ', borderCollapse: 'separate' , borderSpacing: '10px' }}>
                <tr>
                    <td className="card2" rowspan="2">
                        <div  style={{marginTop: '10px' , width:'99%' , height: '30%' , display: 'inline-block' , verticalAlign: 'top'}} > 
                            <span>Angajati prezenti/astazi</span>

                        
                            <Line data={data}/>
                            {/* <canvas style={{width: '100%' , height: '30%' , margin: '10px'}}></canvas> */}
                        </div>
                    </td>
                    <td className="card2">
                        <b style={{fontSize: '20px'}} >ANGAJATI</b>
                        <br></br>
                ...
                <tr>
                    <td className="card2">
                            <b style={{fontSize: '20px'}}>SCANARI</b>
                            <br></br>
                            <b style={{fontSize: '40px'}}>
                                <span>{set3last}</span>
                            </b>
